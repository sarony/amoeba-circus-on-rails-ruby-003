class ActsController < ApplicationController
  ...
  def create
    ...
    if params[:performer]
      params[:performer].each do |performer_id|
        @act.act_performers.build(:performer_id => performer_id.to_i)
      end
    else
    end
  ...
  private
    ...
    def act_params
      params.require(:act).permit(:name, :date, :time)
    end
end
